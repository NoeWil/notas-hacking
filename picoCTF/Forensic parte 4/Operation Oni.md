...
``` bash
┌──(wil㉿DESKTOP-FKOIV4I)-[~/forensic/operationoni]
└─$ mmls disk.img
DOS Partition Table
Offset Sector: 0
...
┌──(wil㉿DESKTOP-FKOIV4I)-[~/forensic/operationoni]
└─$ fls -o 206848 disk.img -r 458

┌──(wil㉿DESKTOP-FKOIV4I)-[~/forensic/operationoni]
└─$ fls -o 206848 disk.img -r 470
...
┌──(wil㉿DESKTOP-FKOIV4I)-[~/forensic/operationoni]
└─$ ssh -i key_file -p 62936 ctf-player@saturn.picoctf.net
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
┌──(wil㉿DESKTOP-FKOIV4I)-[~/forensic/operationoni]
└─$ chmod key_file
chmod: missing operand after ‘key_file’
Try 'chmod --help' for more information.

┌──(wil㉿DESKTOP-FKOIV4I)-[~/forensic/operationoni]
└─$ ls -la key_file
-rw-r--r-- 1 wil wil 411 Oct 14 11:20 key_file
